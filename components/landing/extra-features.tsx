...
export function LandingExtraFeatures() {
    return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {features.map((feature, index) => {
                        ...
                        return (
                            <div
                                key={feature.title}
                                className={`group relative bg-white p-8 transition-all hover:bg-orange-50/50 hover:shadow-xl hover:shadow-orange-500/10 ${!isTopRow ? 'border-t border-orange-200' : ''
